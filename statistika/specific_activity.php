...
$result.= "
        ...
        document.getElementById(\"statistics\").innerHTML = '<canvas id=\"specific_activity\"  width=1000px height=700px ></canvas><canvas id=\"week_activities\" width=0px height=0px ></canvas><canvas id=\"subject_activities\" width=0px height=0px></canvas>';
