...
$result.= "
        ...
        document.getElementById(\"statistics\").innerHTML = '<canvas id=\"subject_activities\" width=500px height=300px></canvas><canvas id=\"week_activities\"  width=0px height=0px ></canvas><canvas id=\"specific_activity\"  width=0px height=0px ></canvas>';
